...
| หมุนประมาณ $45^\circ$ | 640 | 584 | 20 % | [ ✓ ] ตรง [ ] ไม่ตรง | CLOUD: SYSTEM READY |
| กึ่งกลาง ($90^\circ$) | 1300 | 779 | 27 % | [ ✓ ] ตรง [ ] ไม่ตรง | CLOUD: SYSTEM READY |
| หมุนประมาณ $135^\circ$| 2358 | 1381 | 51 % | [ ✓ ] ตรง [ ] ไม่ตรง | CLOUD: SYSTEM READY |
| หมุนขวาสุด ($180^\circ$)| 2600 | 2600 | 100 %  | [ ✓ ] ตรง [ ] ไม่ตรง | CLOUD: RSYSTEM READY |
...
1. **การวิเคราะห์จุดคอขวด (Bottleneck Analysis)**  
   ...
   *จงอธิบายเหตุผลประกอบการคำนวณอัตราเร็วการส่งข้อมูล*
   คำตอบ: 
   พอร์ต Serial UART 115200 bps มีโอกาสเป็นคอขวดมากที่สุด เนื่องจากมีอัตราการส่งข้อมูลต่ำกว่า SPI2 ที่ทำงานที่ความเร็ว 10 MHz โดย SPI2 สามารถส่งข้อมูลได้ประมาณ 10,000,000 bit/s ในขณะที่ UART ส่งข้อมูลที่ 115,200 bit/s ดังนั้น UART จึงมีความเร็วในการรับส่งข้อมูลต่ำกว่ามาก และอาจทำให้เกิดความหน่วงของระบบได้
...
1. **ประโยชน์ของสถาปัตยกรรม Hybrid Edge-Cloud Fallback**  
   ...
   คำตอบ: 
   ระบบ Hybrid Edge-Cloud Fallback ช่วยให้ระบบยังสามารถทำงานต่อได้เมื่อการเชื่อมต่อกับ Cloud หรือ Server ขาดหายเกิน Timeout โดยระบบจะเปลี่ยนไปประมวลผลที่ Edge ทันที หากไม่มีระบบ Fallback ระบบอาจต้องรอการตอบกลับจาก Server ทำให้เกิดความล่าช้าและไม่สามารถตอบสนองต่อสถานการณ์ได้ทันเวลา
...
2. **ความถูกต้องของการเลือกใช้งาน ADC Channel**  
   ...
   คำตอบ: 
   ADC2 มีการใช้ทรัพยากรร่วมกับ Wi-Fi ภายใน ESP32 จึงอาจเกิดความขัดแย้งเมื่อ Wi-Fi กำลังทำงาน ดังนั้นระบบที่ต้องใช้งาน Wi-Fi ควรเลือกใช้ ADC1 สำหรับอ่านสัญญาณ Analog ในการทดลองนี้ใช้ ADC1 Channel 6 หรือ GPIO34 เชื่อมต่อกับ Potentiometer เพื่ออ่านค่าความต้านทานและแปลงเป็นค่า ADC

### link video LAB-09-3 Update 22/09/2026
https://youtube.com/shorts/T43HZFGv3XI?feature=share