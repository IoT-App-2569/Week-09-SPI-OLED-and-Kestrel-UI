...
https://youtube.com/shorts/d0Oljf3YbkY?si=QRIKQvcscLKpN_L3
...
https://youtube.com/shorts/507dQmV79tU?si=cfRPkC22EnmMIIyI
...
https://youtube.com/shorts/GNkfP6ROI7o?si=mw1HitGO6YyPrJtI
...
```
ะบบควบคุมอุตสาหกรรมต้องมีกลไกสลับมาทำงานที่ Edge ทันทีเมื่อเกิด Timeout เนื่องจากเครือข่ายคลาวด์ไม่สามารถรับประกันความเสถียรได้ 100% (Wi-Fi อาจหลุดหรืออินเทอร์เน็ตขัดข้อง) ในขณะที่กระบวนการทางกายภาพยังคงเปลี่ยนแปลงต่อเนื่องแบบ Real-time การให้ Edge ประมวลผลด้วยข้อมูลเซนเซอร์ที่อ่านได้ ณ ขณะนั้นด้วยตัวเอง จะช่วยให้ระบบสามารถตอบสนองได้ทันท่วงทีและมีความปลอดภัยแม้ไม่มีการเชื่อมต่อคลาวด์ ถือเป็นแนวทางการออกแบบระบบแบบ Fail-Safe

หากไม่มีกลไกนี้

ระบบจะค้างอยู่กับคำสั่งค้าง ค้างอยู่กับคำสั่งหรือค่าล่าสุดที่ได้รับจากคลาวด์ ทั้งที่สภาวะจริงเปลี่ยนไปแล้ว

เกิดความเสียหายต่ออุปกรณ์และผู้ปฏิบัติงาน แขนกลอาจเคลื่อนที่ต่อตามคำสั่งเก่าจนชนขอบเขต หรือระบบระบายความร้อนไม่ปรับพัดลม/วาล์วตามอุณหภูมิที่เพิ่มขึ้น จนอุปกรณ์เกิด Overheat เสียหาย

เกิด Single Point of Failure (SPOF) การพึ่งพาเครือข่ายเพียงอย่างเดียวจะทำให้ระบบขาดเสถียรภาพ และไม่ผ่านมาตรฐานความปลอดภัย (Safety/Real-time Standard) ของงานอุตสาหกรรม
```
...
```
ตัวควบคุม Wi-Fi ของ ESP32 ต้องใช้วงจร ADC2 ผ่านทาง RTC Controller / ADC Arbiter เพื่อสุ่มตรวจสอบและปรับเทียบกำลังส่งสัญญาณ RF ระหว่างที่ Wi-Fi ทำงานโดยเฉพาะช่วงส่งแพ็กเก็ต เมื่อ Wi-Fi Driver ทำงานอยู่ ระบบจะเข้าจองใช้งาน ADC2 โดยอัตโนมัติ ทำให้หากโปรแกรมแอปพลิเคชันพยายามอ่านค่าจาก ADC2 พร้อมกัน จะเกิดการแย่งชิงทรัพยากร (Resource Contention) ส่งผลให้:

 - อ่านค่าแอนะล็อกได้ผิดเพี้ยน ค่าไม่นิ่ง หรือสวิง

 - เกิด Timeout หรือค่าที่อ่านได้ค้าง คืนค่าสุ่ม

 - ในบางกรณีอาจส่งผลให้ไดรเวอร์ Wi-Fi Crash หรือระบบค้างไปโดยสมบูรณ์

ส่วน ADC1 เป็นวงจรอิสระที่ไม่มีการเชื่อมโยงกับโมดูล Wi-Fi ภายในเลย จึงเป็นตัวเลือกเดียวที่ Espressif แนะนำให้ใช้อ่านค่าแอนะล็อกในงาน IoT ที่ต้องเปิดใช้งาน Wi-Fi พร้อมกัน
```
