...
| **Point 2** | ประมาณ 25% | 1115 | 25 % | 25 % | [x] PASS  [ ] FAIL |
| **Point 3** | กึ่งกลาง (50%) | 2050 | 50 % | 50 % | [x] PASS  [ ] FAIL |
| **Point 4** | ประมาณ 75% | 3000 | 75 % | 75 % | [x] PASS  [ ] FAIL |
...
ความล่าช้าน่าจะเกิดจาก กระบวนการส่งข้อมูลไปยังหน้าจอ OLED ผ่านบัส SPI และการอัปเดต Framebuffer โดยเฉพาะขั้นตอน oled_flush() ซึ่งต้องส่งข้อมูลจาก Framebuffer ไปยัง OLED หากขั้นตอนดังกล่าวใช้เวลานาน จะทำให้หน้าจอ OLED แสดงผลช้ากว่าหน้าเว็บ
...
เนื่องจาก SPI 10 MHz มีความเร็วในการส่งข้อมูลสูงกว่า I2C 100 kHz อย่างมาก ทำให้สามารถส่งข้อมูลสำหรับอัปเดตหน้าจอ OLED ได้รวดเร็วกว่า จึงช่วยลดเวลาในการส่งข้อมูลและลดความหน่วงของการแสดงผลในระบบ Closed-Loop
โดย SPI 10 MHz เท่ากับ 10,000 kHz ขณะที่ I2C 100 kHz ดังนั้นความถี่สัญญาณนาฬิกาของ SPI สูงกว่าประมาณ 100 เท่า ส่งผลให้การส่งข้อมูลไปยัง OLED ทำได้รวดเร็วกว่า
