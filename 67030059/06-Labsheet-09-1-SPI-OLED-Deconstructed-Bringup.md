...
```
  ...
  https://youtube.com/shorts/4VI-X7F_1ws?si=vVVPvh3UfqRolHl_  // ลิ้งการแสดงผลการทดลอง
![alt text](S__42246148.jpg)
...
ตัวอักษร 'H' ใช้ข้อมูลจำนวน 5 ไบต์ เนื่องจากฟอนต์ที่ใช้เป็นแบบ Font Matrix 5×7 ซึ่งกำหนดให้ตัวอักษรมีความกว้าง 5 พิกเซล และสูง 7 พิกเซล โดยแต่ละไบต์แทนข้อมูลของพิกเซลใน แต่ละคอลัมน์ของตัวอักษร และแต่ละบิตภายในไบต์จะควบคุมพิกเซลใน ทิศทางแนวตั้ง จำนวน 7 พิกเซล ดังนั้นข้อมูล 5 ไบต์จึงใช้แทน 5 คอลัมน์ของตัวอักษร 'H' ได้
...
D0 คือสาย SPI Clock (SCK) ส่วน D1 คือสาย SPI MOSI (Data) หากสลับสายกัน สัญญาณ Clock และ Data จะถูกส่งไปยังขาผิดประเภท ทำให้ SSD1306 ไม่สามารถรับและตีความข้อมูล SPI ได้อย่างถูกต้อง ส่งผลให้ไม่สามารถสื่อสารกับจอได้ตามปกติ ดังนั้นจออาจ ไม่ติดหรือไม่แสดงผลตามที่โปรแกรมกำหนด แม้ ESP32 จะยังทำงานและส่งสัญญาณออกมาอยู่ก็ตาม
