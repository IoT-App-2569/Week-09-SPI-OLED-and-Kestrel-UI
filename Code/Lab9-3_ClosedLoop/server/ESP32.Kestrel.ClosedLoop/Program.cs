// ==========================================================================
//  Lab 9.3 : Closed-Loop IoT Gateway (Full-Duplex Serial Bridge + Web Dashboard)
//  รัน:  dotnet run   ->  http://localhost:5127 (ดูพอร์ตจริงใน terminal)
//  ตั้งค่าพอร์ต COM จริงที่ appsettings.json -> SerialPort:PortName
// ==========================================================================

using ESP32.Kestrel.ClosedLoop.Services;
