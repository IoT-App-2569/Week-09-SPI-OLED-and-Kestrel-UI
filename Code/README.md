...
| ESP-IDF | v6.1 | ✅ **คอมไพล์และแฟลชลงบอร์ด ESP32 จริงสำเร็จแล้ว** (Lab 9.1 และ 9.3) — ทดสอบโดยนักศึกษาบนเครื่องที่ติดตั้ง ESP-IDF v6.1 |

**หลักฐานภาพฮาร์ดแวร์จริง:** [`Image/`](../Image/) — ภาพถ่ายบอร์ด ESP32 + OLED จริงขณะรัน Lab 9.1 และ Lab 9.3 (Checkpoint 3.2 Edge→Cloud) ฝังอยู่ในไฟล์ Answer ที่เกี่ยวข้องแล้ว
