...
*   **จุดคอขวด:** มักเกิดที่ **กระบวนการอัปเดตและวาดหน้าจอ (Display Rendering Loop)** 
*   **สาเหตุ:** การวาดกราฟิกบนจอต้องส่งข้อมูล Framebuffer ขนาด 1KB ใหม่ทั้งหมดในทุกรอบลูป (Full Redraw) ซึ่งหากโค้ดเขียนแบบทำงานตามลำดับ (Blocking) หรือมีการใช้ `delay()` จะทำให้จออัปเดตช้า ในขณะที่การส่งข้อมูลตัวเลขสั้น ๆ ผ่านเครือข่ายไปยังหน้าเว็บนั้นใช้ขนาดข้อมูลน้อยกว่าและประมวลผลได้เร็วกว่ามาก
...
*   **เหตุผลหลัก:** **แบนด์วิดท์ (Bandwidth) และเวลาในการส่งข้อมูลที่ต่างกันมหาศาล**
*   **คำอธิบาย:** SPI (10 MHz) มีความเร็วสัญญาณนาฬิกาเร็วกว่า I2C (100 kHz) ถึง 100 เท่า การส่งข้อมูล Framebuffer 1KB เพื่อรีเฟรชจอผ่าน SPI ใช้เวลาเพียงเสี้ยววินาที (~1 ms) ในขณะที่ I2C อาจใช้เวลานานเกือบ 100 ms ซึ่งในระบบ Closed-Loop ที่ต้องการการตอบสนองกลับแบบทันทีทันใด (Real-time Feedback) ความล่าช้าระดับ 100 ms จะทำให้การแสดงผลกระตุกและไม่ทันต่อเหตุการณ์จริง