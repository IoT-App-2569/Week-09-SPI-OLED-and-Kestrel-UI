...
เวลาที่คำสั่งถูกเขียนลงพอร์ต Serial ไปจนถึงจังหวะที่จอ OLED วาดข้อความใหม่สำเร็จ **`3.82 ms`** (คำนวณจากเวลาส่งแพ็กเก็ตผ่านสาย Serial UART 115200 bps ประมาณ 3.0 ms + เวลาที่ ESP32 ส่งข้อมูล Framebuffer 1024 ไบต์ขึ้นจอ OLED ผ่านบัส SPI 10 MHz อีกประมาณ 0.82 ms)

**สรุปการแจกแจงเวลาหน่วงในวงรอบปิด (Round-Trip Latency Breakdown):**
1. เวลาที่ Kestrel ใช้ประมวลผลภายใน รับคำขอและอัปเดตสถานะ: ใช้เวลาจริงเพียง 1.64 มิลลิวินาที
