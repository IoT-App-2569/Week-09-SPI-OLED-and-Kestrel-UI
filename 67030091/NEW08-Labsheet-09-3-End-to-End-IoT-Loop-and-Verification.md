...
- เวลาที่คำสั่งถูกเขียนลงพอร์ต Serial ไปจนถึงจังหวะที่จอ OLED วาดข้อความใหม่สำเร็จ `86 ms`
...
| :---: | :---: | :---: | :---: | :---: | :---: |
| หมุนซ้ายสุด ($0^\circ$) | 0  | 0 | 0% | [✓] ตรง [ ] ไม่ตรง | SYSTEM READY |
| หมุนประมาณ $45^\circ$ | 250 | 584 | 20% | [] ตรง [✓] ไม่ตรง | SYSTEM READY |
| กึ่งกลาง ($90^\circ$) | 1300 | 779 | 27% | [] ตรง [✓] ไม่ตรง | SYSTEM READY |
| หมุนประมาณ $135^\circ$| 2300 | 1381 | 51% | [ ] ตรง [✓] ไม่ตรง | SYSTEM READY |
| หมุนขวาสุด ($180^\circ$)| 2600 | 2600 | 100% | [✓] ตรง [ ] ไม่ตรง | SYSTEM READY |
...
**ตอบ**
ถ้า $\Delta T$ สูงเกิน 200 ms ส่วนที่มีโอกาสเป็นคอขวดมากที่สุดคือ UART 115200 bps เพราะมีความเร็วในการส่งข้อมูลต่ำกว่า SPI ที่ 10 MHz มาก

SPI 10 MHz สามารถส่งข้อมูล 1 KB ได้ประมาณ

$$
\frac{1024 \times 8}{10,000,000} \approx 0.82 ms
$$

ส่วน UART 115200 bps ส่งข้อมูลได้ประมาณ 11.52 KB/s ดังนั้น UART จึงช้ากว่า SPI มาก อย่างไรก็ตาม ถ้าความหน่วงเกิน 200 ms จริง ควรตรวจสอบการประมวลผลของ Kestrel และการรอรอบการทำงานเพิ่มเติมด้วย
...
**ตอบ**
ระบบต้องมี Edge Fallback เพราะถ้า Cloud หรือ Kestrel ขาดการเชื่อมต่อ ระบบยังสามารถประมวลผลค่าจากเซนเซอร์ที่ ESP32 ได้เอง
ในการทดลอง ถ้าไม่ได้รับข้อมูลจาก Kestrel เกิน 1.5 วินาที ระบบจะเปลี่ยนกลับเป็น EDGE MODE โดยอัตโนมัติ

ถ้าไม่มีระบบนี้ เมื่อเครือข่ายขาด ระบบอาจต้องรอ Server ทำให้การตอบสนองล่าช้า และระบบควบคุมอาจหยุดทำงานได้
...
**ตอบ**
ควรใช้ ADC1 เมื่อระบบ ESP32 เปิด Wi-Fi เพราะ ADC2 ใช้ทรัพยากรร่วมกับวงจร Wi-Fi ภายในชิป ทำให้ไม่สามารถใช้งาน ADC2 ได้อย่างอิสระในขณะที่ Wi-Fi ทำงาน

ดังนั้นในการทดลองจึงเลือกใช้ GPIO 34 ซึ่งเป็น ADC1 สำหรับอ่านค่า Potentiometer เพื่อให้สามารถใช้งานร่วมกับระบบ IoT ได้อย่างเสถียร


***LINK VIDEO***
https://youtube.com/shorts/VA04U9jWYNg?feature=share 
