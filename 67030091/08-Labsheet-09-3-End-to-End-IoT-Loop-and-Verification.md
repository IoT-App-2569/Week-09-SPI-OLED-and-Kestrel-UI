...
| :---: | :--- | :---: | :---: | :---: | :---: |
| **Point 1** | หมุนซ้ายสุด (Min) | __________ | _______ % | _______ % | [ ] PASS  [ ] FAIL |
| **Point 2** | ประมาณ 25% | __________ | _______ % | _______ % | [ ] PASS  [ ] FAIL |
| **Point 3** | กึ่งกลาง (50%) | __________ | _______ % | _______ % | [ ] PASS  [ ] FAIL |
| **Point 4** | ประมาณ 75% | __________ | _______ % | _______ % | [ ] PASS  [ ] FAIL |
| **Point 5** | หมุนขวาสุด (Max) | __________ | _______ % | _______ % | [ ] PASS  [ ] FAIL |
