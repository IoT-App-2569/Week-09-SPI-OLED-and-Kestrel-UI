...
| :---: | :--- | :---: | :---: | :---: | :---: |
| **Point 1** | หมุนซ้ายสุด (Min) | 0 | 0.0 % | 0.0 % | [✓] PASS  [ ] FAIL |
| **Point 2** | ประมาณ 25% | 1123 | 27.4 % | 27.4 % | [✓] PASS  [ ] FAIL |
| **Point 3** | กึ่งกลาง (50%) | 2062 | 50.4 % | 50.4 % | [✓] PASS  [ ] FAIL |
| **Point 4** | ประมาณ 75% | 3024 | 73.9 % | 73.9 % | [✓] PASS  [ ] FAIL |
| **Point 5** | หมุนขวาสุด (Max) | 4095 | 100.0 % | 100.0 % | [✓] PASS  [ ] FAIL |
...
# คำตอบคำถามท้ายการทดลอง Lab 9.3

1. หาก OLED แสดงผลช้ากว่าหน้าเว็บ สาเหตุน่าจะเกิดจากจุดไหน?

น่าจะเกิดจากการสื่อสารระหว่าง **Kestrel Server กับ ESP32** หรือการอัปเดตข้อมูลบน **OLED** ที่ใช้เวลานาน ทำให้ค่าที่ส่งกลับไปแสดงบน OLED ช้ากว่าหน้าเว็บ

**รูป:** แนะนำให้ใส่รูปการทำงานที่เห็นว่า Web Dashboard อัปเดตก่อน OLED

---

2. ทำไม SPI 10 MHz จึงลดความหน่วงได้ดีกว่า I2C 100 kHz?

เพราะ SPI มีความเร็วในการส่งข้อมูลสูงกว่า I2C มาก โดย SPI 10 MHz ส่งข้อมูลได้เร็วกว่า I2C 100 kHz ทำให้ส่งข้อมูลไปอัปเดต OLED ได้เร็วขึ้น และช่วยลดเวลาในการรอของระบบ Closed-Loop

**รูป:** ไม่จำเป็นต้องใส่
